-- Combined migration to fix missing asset_measurements table
...
-- Add items_snapshot column if it doesn't exist
...
-- Create an index for efficient querying by company
